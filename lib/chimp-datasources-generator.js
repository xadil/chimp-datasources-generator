...
program
  ...
  .action(function (directory, location, options) {
    ...
    let shellCommand = `java -jar ${pathToSwagger} generate -l typescript-fetch --template-dir ${pathToTemplate} -i ${resolvedAPI} -o ${resolvedPath}`;
